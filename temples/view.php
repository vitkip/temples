...
<div class="flex justify-between items-center mb-8">
    <div>
        <h1 class="text-2xl font-bold text-gray-800"><?= htmlspecialchars($temple['name']) ?></h1>
        <p class="text-sm text-gray-600"><?= htmlspecialchars($temple['district'] ?? '') ?>, <?= htmlspecialchars($temple['province'] ?? '') ?></p>
    </div>
    <div class="flex space-x-2">
        ...
        <?php if ($can_edit): ?>
        <a href="<?= $base_url ?>temples/edit.php?id=<?= $temple['id'] ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg flex items-center transition">
            <i class="fas fa-edit mr-2"></i> ແກ້ໄຂ
        </a>
        <?php if ($_SESSION['user']['role'] === 'superadmin'): ?>
        <a href="<?= $base_url ?>temples/delete.php?id=<?= $temple['id'] ?>" class="bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-lg flex items-center transition">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800">
                            <?php if (!empty($temple['website'])): ?>
                                <a href="<?= htmlspecialchars($temple['website']) ?>" target="_blank" class="text-indigo-600 hover:text-indigo-800">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">ລາຍລະອຽດ</h2>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold text-gray-800">ພະສົງ</h2>
                    <a href="<?= $base_url ?>monks/?temple_id=<?= $temple_id ?>" class="text-indigo-600 hover:text-indigo-800 text-sm">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold text-gray-800">ກິດຈະກໍາ</h2>
                    <a href="<?= $base_url ?>events/?temple_id=<?= $temple_id ?>" class="text-indigo-600 hover:text-indigo-800 text-sm">
                        ເບິ່ງທັງໝົດ <i class="fas fa-arrow-right ml-1"></i>
                    </a>
                </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">ທີ່ຕັ້ງ</h2>
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">ຕິດຕໍ່</h2>
