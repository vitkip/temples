<?php
// filepath: c:\xampp\htdocs\temples\subscription_plans\add.php
ob_start();
session_start();
    ...
    if (empty($errors)) {
        try {
            $sql = "
                ...
                (name, description, price, duration_months, features, status) 
                VALUES (?, ?, ?, ?, ?, ?)
            ";
            ...
            $_SESSION['success'] = "ເພີ່ມແຜນການສະໝັກສະມາຊິກໃໝ່ສໍາເລັດແລ້ວ";
...
$page_title = "ເພີ່ມແຜນການສະໝັກສະມາຊິກ";
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">ເພີ່ມແຜນການສະໝັກສະມາຊິກ</h1>
            <p class="text-sm text-gray-600">ສ້າງແຜນການສະໝັກສະມາຊິກໃໝ່ສໍາລັບລະບົບ</p>
        </div>
        <div>
