            ...
            <form action="<?= $base_url ?>monks/edit.php?id=<?= $monk_id ?>" method="post" enctype="multipart/form-data" id="editMonkForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="id_card" class="block text-sm font-medium text-gray-700 mb-1">ລະຫັດບັດປະຊາຊົນ <span class="text-red-500">*</span></label>
                            <input type="text" name="id_card" id="id_card" class="form-input w-full" value="<?= htmlspecialchars($monk['id_card']) ?>">
                        </div>
                        <div>
