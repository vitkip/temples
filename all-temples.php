...
<head>
    ...
    <title><?= $page_title ?> | <?= isset($site_name) ? $site_name : 'ລະບົບຈັດການຂໍ້ມູນວັດ' ?></title>
    <!-- Tailwind CSS -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <!-- Google Fonts - Noto Sans Lao -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Noto+Sans+Lao:wght@400;500;600;700&display=swap">
    <!-- Custom CSS -->
    ...
    <style>
        ...
        /* Hero section */
        .hero-section {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?= $base_url ?>assets/images/temple-hero.jpg');
...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <a href="<?= $base_url ?>" class="flex-shrink-0 flex items-center">
                        ...
                        <span class="ml-2 font-semibold text-gray-900">ລະບົບຈັດການຂໍ້ມູນວັດ</span>
                    </a>
                </div>
                <div class="flex items-center">
                    <a href="<?= $base_url ?>" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                        ໜ້າຫຼັກ
                    </a>
                    <a href="<?= $base_url ?>all-temples.php" class="bg-amber-50 text-amber-800 px-3 py-2 rounded-md text-sm font-medium">
                        ວັດທັງໝົດ
                    </a>
                    <a href="<?= $base_url ?>about.php" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                        ກ່ຽວກັບພວກເຮົາ
                    </a>
                    <a href="<?= $base_url ?>contact.php" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                        ຕິດຕໍ່
                    </a>
                </div>
            </div>
    ...
    <section class="hero-section">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl md:text-4xl font-bold mb-4">ວັດທັງໝົດໃນລະບົບ</h1>
            <p class="text-xl text-gray-100 max-w-lg mx-auto">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                <h2 class="text-xl font-bold text-gray-800 mb-4 md:mb-0">
                    <i class="fas fa-search text-amber-600 mr-2"></i> ຄົ້ນຫາ ແລະ ກັ່ນຕອງ
                </h2>
        ...
        <?php if (count($temples) > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden temple-card">
                    ...
                    <div class="p-4 card-body">
                        ...
                        <div class="text-sm text-gray-600 mb-4 line-clamp-2">
                            <?= htmlspecialchars(substr($temple['description'], 0, 100)) . (strlen($temple['description']) > 100 ? '...' : '') ?>
                        </div>
                        <?php endif; ?>
                        
                        <div class="card-footer">
                            <a href="<?= $base_url ?>temples/view.php?id=<?= $temple['id'] ?>" 
                               class="block w-full text-center px-4 py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-lg transition">
                                ເບິ່ງລາຍລະອຽດ <i class="fas fa-arrow-right ml-1"></i>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Footer -->
    <footer class="bg-gray-800 pt-10 pb-8 mt-12 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-lg font-semibold mb-4">ກ່ຽວກັບພວກເຮົາ</h3>
                    <p class="text-gray-300 mb-4">ລະບົບຈັດການຂໍ້ມູນວັດ ແລະ ພະສົງ ເພື່ອເປັນແຫຼ່ງຂໍ້ມູນທາງພຣະພຸດທະສາສະໜາ.</p>
                </div>
                
                <div>
                    <h3 class="text-lg font-semibold mb-4">ລິ້ງທີໍາຄັນ</h3>
                    <ul class="space-y-2">
                        <li><a href="<?= $base_url ?>" class="text-gray-300 hover:text-white">ໜ້າຫຼັກ</a></li>
                        <li><a href="<?= $base_url ?>all-temples.php" class="text-gray-300 hover:text-white">ວັດທັງໝົດ</a></li>
                        <li><a href="<?= $base_url ?>about.php" class="text-gray-300 hover:text-white">ກ່ຽວກັບພວກເຮົາ</a></li>
                        <li><a href="<?= $base_url ?>contact.php" class="text-gray-300 hover:text-white">ຕິດຕໍ່</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-center">
                            ...
                            <span class="text-gray-300">ນະຄອນຫຼວງວຽງຈັນ, ລາວ</span>
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-envelope mr-2 text-amber-500"></i>
                            <span class="text-gray-300">contact@temple-system.la</span>
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-phone mr-2 text-amber-500"></i>
                            <span class="text-gray-300">+856 20 xxxx xxxx</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-700 text-center text-gray-400">
                <p>&copy; <?= date('Y') ?> ລະບົບຈັດການຂໍ້ມູນວັດ. ສະຫງວນລິຂະສິດທັງໝົດ.</p>
            </div>
        </div>
    </footer>
    ...
    <nav class="bottom-nav md:hidden">
        <a href="<?= $base_url ?>" class="bottom-nav-item">
            <i class="fas fa-home"></i>
            <span>ໜ້າຫຼັກ</span>
        </a>
        <a href="<?= $base_url ?>all-temples.php" class="bottom-nav-item active">
            <i class="fas fa-place-of-worship"></i>
            <span>ວັດທັງໝົດ</span>
        </a>
        <a href="#" id="showFilterBtn" class="bottom-nav-item">
            <i class="fas fa-filter"></i>
            <span>ຕົວກອງ</span>
        </a>
        <a href="<?= $base_url ?>contact.php" class="bottom-nav-item">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (showFilterBtn) showFilterBtn.addEventListener('click', openFilterDrawer);
